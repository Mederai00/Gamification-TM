    ...
    <div className="navbar">
      <div className="leftSide" id={openLinks ? "open" : "close"}>
        ...
        <div className="hiddenLinks">
          ...
          <Link to="/categories" className=" mx-1  p-2 rounded-lg">
            Take Quiz
          </Link>
          <Link to="/ChooseLeaderBoard" className=" mx-1  p-2 rounded-lg">
            LeaderBoard
          </Link>
          <Link to="/MyProfile" className="  p-2 rounded-lg">
            Profile
          </Link>
        </div>
      </div>
      ...
      <div className="rightSide">
        <Link to="/course"> Take Course</Link>
